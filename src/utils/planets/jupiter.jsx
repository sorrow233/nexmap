...
export const jupiterTexture = {
    ...
    detail: (
        <>
            {/* 1. Turbulence / Storm Noise */}
            <div className="absolute inset-0 bg-[url('https://raw.githubusercontent.com/catzz/aimainmap-assets/main/noise-texture.png')] opacity-30 mix-blend-overlay bg-repeat bg-[length:50px_50px]"></div>

            {/* 2. The Great Red Spot (Anti-cyclonic storm) */}
            <div className="absolute top-[60%] left-[25%] w-[30%] h-[18%] bg-red-800/80 rounded-[50%] blur-[2px] shadow-[inset_2px_2px_6px_rgba(0,0,0,0.4)] rotate-[-10deg] mix-blend-multiply"></div>

            {/* 3. Equatorial Storms (White ovals) */}
            <div className="absolute top-[45%] right-[10%] w-[15%] h-[5%] bg-white/40 blur-[4px] rounded-full mix-blend-screen"></div>
