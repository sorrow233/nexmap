...
export const terraTexture = {
    ...
    detail: (
        <>
            {/* 1. Continents (Procedural Shapes - Static for now, could animate globally if needed) */}
            <div className="absolute top-[20%] left-[20%] w-[25%] h-[35%] bg-emerald-600/60 blur-[6px] rounded-[40%_60%_70%_30%/40%_50%_60%_50%] rotate-12 mix-blend-overlay border border-emerald-400/20"></div>
            ...
            {/* 2. Cloud Layer (Moving) */}
            <div className="absolute inset-0 opacity-80 mix-blend-screen animate-[spin_120s_linear_infinite]">
                {/* Cloud 1 */}
                <div className="absolute top-[30%] left-[10%] w-[40%] h-[15%] bg-white/80 blur-[8px] rounded-full transform skew-x-12"></div>
                {/* Cloud 2 */}
                <div className="absolute bottom-[20%] right-[10%] w-[50%] h-[10%] bg-white/70 blur-[10px] rounded-full rotate-12"></div>
                {/* Cloud 3 */}
                <div className="absolute top-[50%] left-[40%] w-[20%] h-[20%] bg-white/60 blur-[12px] rounded-full"></div>
            </div>

            {/* 3. Specular Ocean Glint */}
            <div className="absolute top-[35%] left-[35%] w-[10%] h-[10%] bg-white/90 blur-[15px] rounded-full mix-blend-overlay animate-pulse-slow"></div>
        </>
    )
};
