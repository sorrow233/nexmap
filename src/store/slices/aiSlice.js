...
import { keepOnlyCurrentUserMessageImages } from '../../services/ai/chatContextImages';
...
const trimConversationMessagesForContext = (messages = []) => {
    ...
    if (assistantChars <= MAX_CHAT_CONTEXT_ASSISTANT_TOTAL_CHARS) {
        return keepOnlyCurrentUserMessageImages(assistantLimitedMessages);
    }
    ...
    return keepOnlyCurrentUserMessageImages(assistantLimitedMessages.filter((message, index) => (
