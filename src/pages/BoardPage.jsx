...
export default function BoardPage({ user, boardsList, onUpdateBoardTitle, onUpdateBoardMetadata, onBack }) {
    ...
    // Auto-generate background logic REMOVED to prevent unexpected credit usage/behavior.
    // Users must manually trigger generation via the UI.
    // hasAutoGeneratedRef kept just in case we need it later or for other checks.
