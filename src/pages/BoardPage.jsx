...
export default function BoardPage({ user, boardsList, onUpdateBoardTitle, onUpdateBoardMetadata, onBack }) {
    ...
    useEffect(() => {
        ...
        if (currentBoardId && activeCardsCount > 0 && !hasAutoGeneratedRef.current && !currentBoard?.backgroundImage) {
            console.log(`[AutoGen] Triggering! activeCards: ${activeCardsCount} > 0`);
