...
export default function BoardPage({ user, boardsList, onUpdateBoardTitle, onUpdateBoardMetadata, onBack }) {
    ...
    // Auto-generate background when cards > 10
    useEffect(() => {
        if (currentBoardId && cards.length > 10 && !hasAutoGeneratedRef.current && !currentBoard?.backgroundImage) {
    ...
    }, [cards.length, currentBoardId, onUpdateBoardMetadata]);
