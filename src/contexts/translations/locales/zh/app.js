export const app = {
    ...
    chat: {
        ...
        selectionHint: "点击消息继续选择",
        selectionToolbar: "消息删除选择",
        selectAll: "全选",
        deselectAll: "取消全选",
        cancel: "取消",
        deleteSelected: "删除",
        batchDeleteConfirm: "确认删除选中的 {count} 条消息吗？\n\n删除后它们会立即从当前会话移除，后续上下文也不会再包含这些消息。",
    ...
    stats: {
        ...
        dataInsights: "数据概览",
        copyActivity: "复制活动记录",
        copyingActivity: "正在整理...",
        activityCopied: "已复制",
        activityCopyFailed: "复制失败",
        copyActivityHint: "复制所有卡片的创建时间和标题，不包含正文",
        refreshCloud: "检查额度",
        syncing: "检查中...",
        refresh: "刷新",
        totalElements: "总卡片",
