        ...
        changes: [
            {
                ...
                title: "SEOとアクセシビリティ",
                items: [
                    "ページごとの動的SEOメタタグを実装 (react-helmet-async)",
                    "Google検索表示用の適切なファビコンを追加",
                    "クリックできないユーザーメニューボタンを修正 (CSSスタッキングコンテキスト)",
                    "無料ユーザー向けの無料画像生成を追加 (週20枚)",
                    "無料版の会話モデルをKimi-K2-Thinkingに切り替え"
                ]
            },
            {
                date: "2026年1月3日",
                ...
                title: "国際化と同期",
                items: [
                    "完全な4言語サポート (EN, ZH, JA, KO)",
                    "アプリアイコンを新しいNexMapマインドマップロゴに更新",
                    "ボードプロンプト (タグ) のクラウド同期問題を修正",
                    "サイドバーでのMac IMEの位置問題を修正"
                ]
            },
            {
                date: "2026年1月3日",
                ...
                title: "サイドバーとゾーン",
                items: [
                    "サイドバーをNotionスタイルのフローティングタグに再設計",
                    "カードの素早いグループ化のためのゾーン (Zone) ボタンを追加",
                    "ドラッグアンドドロップ対応のプロンプトサイドバーを実装",
                    "BoardPageでの無限ループバグを修正"
                ]
            },
            {
                date: "2025年12月31日",
                ...
                title: "スプラウトとブランチ",
                items: [
                    "ワンクリックでトピックを分解するクイックスプラウト (Sprout) を追加",
                    "「好奇心最大化」プロンプト戦略を実装",
                    "スプラウト/ブランチ用の標準マインドマップレイアウト",
                    "新しいカード配置の衝突検出を追加"
                ]
            },
            {
                ...
                title: "画像とエクスポート",
                items: [
                    "いらすとやスタイルのプロンプトで画像生成を改善",
                    "iPad Safariでの画像エクスポート問題を修正",
                    "ユーザーカスタム指示のサポートを追加",
                    "エラー処理向上のためGeminiプロバイダーをモジュール化"
                ]
            },
            {
                date: "2025年12月30日",
                ...
                title: "ギャラリーのモダン化",
                items: [
                    "グラスモーフィズムでギャラリーUIをモダン化",
                    "モバイルでのスクロール問題を解決",
                    "APIエラーの自動再試行を追加 (最大2回)",
                    "設定による手動言語切り替えを有効化"
                ]
            },
            {
                ...
                items: [
                    "Gemini 400検証エラーを修正",
                    "AIマネージャーのメッセージ損失問題を解決",
                    "API互換性のために画像データをサニタイズ"
                ]
            },
            {
                date: "2025年12月28日",
            ...
            },
            {
                ...
                title: "ローカリゼーション",
                items: [
                    "料金ページの内容をローカライズ (EN, ZH, JA)",
                    "特定商取引法およびプライバシーポリシーページを追加",
                    "地域ベースのアクセス制限を実装"
                ]
            },
            {
