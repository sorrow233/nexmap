...
export default function BoardDropZone({ onCreateBoard, variant = 'default' }) {
    ...
    const frameClassName = isCompact
        ? `relative rounded-[1.35rem] bg-transparent p-0 shadow-none transition-all duration-300 ${isDragging ? 'ring-2 ring-cyan-300/18' : ''}`
    ...
    return (
        <div className={outerClassName}>
            ...
            >
                ...
                {isCompact ? (
                    <div className="rounded-[1.3rem] bg-white/[0.03] p-1.5 ring-1 ring-white/8">
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="inline-flex h-11 min-w-[5.5rem] shrink-0 items-center justify-center rounded-[1rem] bg-white px-4 text-[14px] font-black tracking-tight text-slate-950 transition-all active:scale-[0.99] disabled:opacity-35 disabled:cursor-not-allowed"
                            >
