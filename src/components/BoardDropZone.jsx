...
export default function BoardDropZone({ onCreateBoard, variant = 'default' }) {
    ...
    const glowClassName = isCompact
        ? 'absolute inset-0 rounded-[2rem] bg-gradient-to-r from-cyan-500/12 via-blue-500/10 to-indigo-500/14 blur-2xl opacity-70'
    ...
    const frameClassName = isCompact
        ? `relative rounded-[2rem] border border-white/10 bg-[#121621]/94 p-3.5 shadow-[0_18px_60px_-34px_rgba(15,23,42,0.92)] transition-all duration-300 ${isDragging ? 'border-cyan-300/35 ring-2 ring-cyan-300/18' : ''}`
                ...
                {isCompact ? (
                    <>
                        <div className="flex items-center gap-2.5">
                            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-[1rem] bg-cyan-400/12 text-cyan-200">
                            ...
                            <input
                                ...
                                className="h-11 min-w-0 flex-1 rounded-[1rem] bg-white/[0.04] px-4 text-[15px] font-medium tracking-tight text-white outline-none placeholder:text-slate-500"
                            />
                            ...
                            <button
                                ...
                                disabled={isSubmitting}
                                className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-[1rem] bg-white/[0.05] text-slate-300 transition-all active:scale-95"
                                title="Upload Image"
                            >
                        ...
                        <button
                            ...
                            className="mt-3 inline-flex h-12 w-full items-center justify-center rounded-[1.2rem] bg-cyan-400 text-[15px] font-black tracking-tight text-slate-950 transition-all active:scale-[0.99] disabled:opacity-35 disabled:cursor-not-allowed"
                        >
