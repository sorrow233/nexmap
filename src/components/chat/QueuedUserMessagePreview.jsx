...
export default function QueuedUserMessagePreview({ pendingMessage = {} }) {
    ...
    return (
        <div className="chat-message-frame chat-message-frame--user relative flex justify-end">
            <div className="max-w-[85%] rounded-3xl rounded-tr-none border border-amber-200/80 bg-amber-50/85 p-6 text-slate-800 shadow-sm dark:border-amber-400/20 dark:bg-amber-500/10 dark:text-slate-100 sm:max-w-[75%]">
