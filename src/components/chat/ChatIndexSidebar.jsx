...
export default function ChatIndexSidebar({ messages, onScrollTo }) {
    ...
    return (
        <div className="hidden xl:flex flex-col gap-1 w-36 shrink-0 opacity-5 hover:opacity-100 transition-all duration-700 animate-fade-in group/index" style={{ animationFillMode: 'forwards' }}>
