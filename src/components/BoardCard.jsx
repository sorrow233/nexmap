            ...
            <div
                ...
                <div className="relative w-full aspect-[16/10] overflow-hidden bg-slate-100 dark:bg-[#111]">
                    {hasImage ? (
                        ...
                        // AI Text Cover Variant v2.0 (Premium Dark Glass) - Adapted for Stacked
                        <div className="absolute inset-0 transition-transform duration-700 group-hover:scale-[1.02] bg-[#050505]">
                            ...
                            {/* 4. Glass Surface */}
                            <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 box-shadow-inner ${board.summary.theme === 'orange' ? 'shadow-[inset_0_0_80px_rgba(249,115,22,0.1)]' :
                            ...
                            {/* 5. Minimal AI Content for Small Card */}
                            <div className="relative z-10 flex flex-col h-full p-4 justify-center items-center text-center">
                                {/* Decorative Accent Line */}
                                <div className={`mb-3 h-[2px] w-8 rounded-full bg-gradient-to-r opacity-80 ${board.summary.theme === 'orange' ? 'from-orange-400 to-amber-500' :
                                ...
                                <p className="text-[11px] font-medium text-white/80 leading-[1.6] line-clamp-4 mix-blend-plus-lighter tracking-wide font-inter-tight">
