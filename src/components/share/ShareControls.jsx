                ...
                <div className="space-y-5">
                    <Surface className="bg-[linear-gradient(145deg,rgba(255,255,255,0.96)_0%,rgba(245,250,255,0.96)_100%)]">
                        ...
                        <div className="space-y-4 px-5 py-4">
                            ...
                            <DescriptionNote text={copy.formatHintBody || copy.qualityPinnedHint} />
                        </div>
                    </Surface>
                    ...
                    <Surface className="px-5 py-5">
                        ...
                        <button
                            ...
                            className={`mt-4 flex w-full items-center justify-between gap-4 rounded-[22px] border px-4 py-4 text-left transition-all duration-200 ${
                                showWatermark
                                    ? 'border-slate-900 bg-slate-950 text-white shadow-[0_18px_40px_rgba(15,23,42,0.16)]'
                                    : 'border-slate-200 bg-slate-50/80 text-slate-900 hover:border-slate-300 hover:bg-white'
                            }`}
                        >
                            <div className="min-w-0">
                                <div className={`text-sm font-semibold ${showWatermark ? 'text-white' : 'text-slate-950'}`}>
                                    {copy.brandingToggle}
                                </div>
                                <div className={`mt-1 text-sm leading-6 ${showWatermark ? 'text-white/68' : 'text-slate-500'}`}>
                                    {copy.brandingHint}
                                </div>
                            </div>
                            <span
                                className={`relative inline-flex h-7 w-12 shrink-0 rounded-full transition-colors ${
                                    showWatermark ? 'bg-white/24' : 'bg-slate-300'
                                }`}
                            >
                                <span
