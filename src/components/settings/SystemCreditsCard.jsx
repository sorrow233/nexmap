...
import { Gift, Zap, AlertTriangle } from 'lucide-react';
...
export default function SystemCreditsCard({ currentProvider }) {
    ...
    useEffect(() => {
        ...
        if (!hasApiKey && systemCredits === null && !systemCreditsLoading) {
            loadSystemCredits();
        }
    }, [hasApiKey, systemCredits, systemCreditsLoading, loadSystemCredits]);
