...
export default function SettingsCreditsTab({ onOpenAdvanced }) {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Redeem Section */}
            <div className="rounded-[28px] border border-[#eee3d7] bg-[linear-gradient(135deg,rgba(255,252,247,0.96),rgba(248,243,237,0.92))] p-5 shadow-[0_10px_40px_rgba(95,74,50,0.07)] dark:border-white/10 dark:from-slate-900 dark:to-slate-900/70 sm:p-6">
                <div className="flex items-center gap-3 mb-4">
                    <div className="rounded-2xl bg-[#f3e7d2] p-2 text-[#af7c36] dark:bg-white/10 dark:text-slate-200">
                        <Ticket size={20} />
                    </div>
                    <div>
                ...
                <div className="rounded-[24px] border border-[#eee3d7] bg-[rgba(255,252,247,0.88)] p-1.5 dark:border-white/10 dark:bg-slate-900/60">
                    <div className="flex flex-col gap-2 sm:flex-row">
                        <input
                            ...
                            className="flex-1 rounded-2xl border border-transparent bg-transparent px-4 py-2.5 text-sm uppercase text-[#4e4237] outline-none transition-all placeholder:text-[#b0a08e] focus:border-[#e7d4bb] focus:bg-white dark:text-slate-200 dark:focus:bg-slate-800/80 font-mono"
                        />
                        <button
                ...
                <>
                    <div className="flex justify-center">
                        <button
                            ...
                            className="inline-flex items-center gap-1 rounded-full border border-[#eadfce] bg-[#fffaf4] px-3 py-1 text-xs font-semibold uppercase tracking-widest text-[#8d6d49] transition-colors hover:text-[#6d5d4d] dark:border-white/10 dark:bg-white/8 dark:text-slate-200 dark:hover:text-white"
                        >
                            <Lock size={10} />
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <CreditBenefitCard
                    ...
                    containerClassName="border-[#eee3d7] bg-[rgba(255,252,247,0.9)] dark:border-white/10 dark:bg-slate-800/65"
                    iconWrapClassName="bg-[#f8f2e8] text-[#8d6d49] dark:bg-white/10 dark:text-slate-200"
                />
                <CreditBenefitCard
                    icon={Infinity}
                    ...
                    containerClassName="border-[#eee3d7] bg-[rgba(255,252,247,0.9)] dark:border-white/10 dark:bg-slate-800/65"
                    iconWrapClassName="bg-[#ece6f7] text-[#776496] dark:bg-white/10 dark:text-slate-200"
                />
            </div>
            ...
            {!isChinaUser && (
                <div className="space-y-4 text-center">
                    <div className="mx-auto max-w-xl rounded-[28px] border border-[#eee3d7] bg-[linear-gradient(135deg,rgba(255,252,247,0.96),rgba(248,243,237,0.92))] p-4 dark:border-white/10 dark:bg-white/8 sm:p-5">
                        <button
