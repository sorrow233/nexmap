    ...
    return (
        <section className="space-y-6">
            ...
            <div className="grid gap-6 xl:grid-cols-[0.95fr,1.2fr]">
                <div className="rounded-[30px] border border-[#eee3d7] bg-[rgba(255,252,247,0.82)] p-6 shadow-[0_20px_48px_rgba(95,74,50,0.06)] backdrop-blur-2xl dark:border-white/10 dark:bg-white/6">
                    <div className="flex items-center gap-3">
                        <div className="rounded-[18px] bg-[#e8eff4] p-2.5 text-[#647f92] dark:bg-white/10 dark:text-slate-200">
                            <Globe size={18} />
                        </div>
                        <div>
                ...
                <div className="rounded-[30px] border border-[#eee3d7] bg-[rgba(255,252,247,0.82)] p-6 shadow-[0_20px_48px_rgba(95,74,50,0.06)] backdrop-blur-2xl dark:border-white/10 dark:bg-white/6">
                    <div className="flex items-center gap-3">
                        <div className="rounded-[18px] bg-[#faedd7] p-2.5 text-[#af7c36] dark:bg-white/10 dark:text-slate-200">
                            <Sparkles size={18} />
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold text-[#2f241a] dark:text-white">
                    ...
                    <div className="mt-4 flex flex-wrap items-center justify-between gap-3 rounded-[24px] border border-[#eee3d7] bg-[rgba(255,250,244,0.88)] px-4 py-3 text-sm backdrop-blur-xl dark:border-white/10 dark:bg-white/6">
                        ...
                        <button
                            ...
                            className="rounded-full border border-[#ebdbca] bg-[#fbf3e7] px-4 py-1.5 text-xs font-semibold text-[#8c6b47] transition-all hover:bg-[#fffaf2] dark:border-white/10 dark:bg-white/8 dark:text-slate-200 dark:hover:bg-white/12"
                        >
                            管理高级指令
                        </button>
                    </div>
